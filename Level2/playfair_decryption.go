...
func main() {
	playfair_matrix := [5][5]string{{"S", "E", "C", "U", "R"},
		...
		{"L", "M", "N", "O", "P"},
		{"Q", "V", "W", "X", "Z"}}
	cipher_text := "TR XYCB MH AFC MUVY EOHPTCS, AFCSS TE QCSI NTYIMS TNA AFCSC. EMRBH XAA VAFR MIUCQPUH LMRL CCETOT FN HM AKUXAHK. OTA WANA OTXT FFU EISCWNAF HME BFU MCVA UGTOTRE. BM HYLF IFU UVTY ANE HBSEI QYOQM OUVSF AM EAFTE PYHYS XNSKE IFUSC."
	//key := "SECURITY"
	bigrams := []string{}
