...
int main(int argc, char **argv) {
    ...
    BYTE key[57] = "01101110010111100111101100101110001011101011110101010011";
    char password[] = "mtiinnjsjukpjmfkpmiquitisofofksi";
    BYTE input1[20], input2[20], in_byte1[100], in_byte2[100];
    BYTE output1[100], output2[100];
    ...
    for (int i = 0; i < 16; i++) {
        input2[i] = password[16+i];
    }

    tobyte((char *)input1, in_byte1);
    tobyte((char *)input2, in_byte2);

    key_as_bits(1, key, 6);
    des(in_byte1, output1, 6, 'N');
    des(in_byte2, output2, 6, 'N');
...
// mimkmhmhlolnlmlsolsnghlrskkttnis
// surrihgmie000000